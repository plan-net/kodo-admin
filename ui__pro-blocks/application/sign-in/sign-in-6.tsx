...
export function SignIn6() {
  return (
    <div className="md:flex md:min-h-screen items-center justify-center md:bg-muted">
      <Card className="w-full md:max-w-sm m-auto md:w-[400px] md:rounded-lg border-none shadow-none rounded-none md:border md:shadow-md md:rounded-lg">
        {/* Header section */}

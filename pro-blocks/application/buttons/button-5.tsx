...
export function Button5() {
  return (
    <div className="flex flex-col gap-2 w-[360px] mx-auto mt-10">
      <Button
        variant="outline"
      ...
      >
        ...
        <span className="text-sm font-medium leading-5">Sign in with X</span>
      </Button>
      ...
      >
        <svg
          ...
          xmlns="http://www.w3.org/2000/svg"
        >
          <g clip-path="url(#clip0_3378_20128)">
            <path
